...
// Query untuk mengambil data tiket yang terkait dengan user yang sedang login
        ...
        <table>
            ...
            <tbody>
                ...
                if (mysqli_num_rows($result) == 0) {
                    echo "<tr><td colspan='9' style='text-align: center;'>Belum ada riwayat tiket penerbangan</td></tr>";
                }
                ?>
            </tbody>
        </table>
