...
if(isset($_POST["login"])) {
    ...
    if (empty($username) || empty($password)) {
        ...
        if ($result->num_rows > 0) {
            ...
            } else if($data["role"] == "maskapai") {
                $_SESSION["username"] = $data["username"];
                $_SESSION["id"] = $data["id"];
                $_SESSION["is_login"] = true;
                header("location: ./maskapai/dashboardMaskapai.php");
        ...
        <form action="login.php" method="POST">
            ...
            <div class="form-group">
                ...
                <div style="position:relative;">
                    <input type="password" id="password" name="password" placeholder="Masukkan password" style="padding-right:40px;">
            ...
            <div class="redirect">Belum punya akun?<a href="register.php" style="margin-left: 0.23rem;">Register</a></div>
        </form>
    </main>
    <script>
        // Script untuk togle 
