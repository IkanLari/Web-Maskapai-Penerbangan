...
// Query untuk mengambil data tiket yang sudah diupdate oleh admin yang sedang login
        ...
        <table>
            ...
            <tbody>
                ...
                if (mysqli_num_rows($result) == 0) {
                    echo "<tr><td colspan='10' style='text-align: center;'>Belum ada tiket yang dipesan</td></tr>";
                }
                ?>
            </tbody>
        </table>
