...
if (isset($_POST["register"])) {
    ...
    if (empty($username) || empty($password) || empty($email)) {
        ...
        try {
            $sql = "INSERT INTO user (username, role, password, email) VALUES ('$username', 'maskapai', '$hash_password', '$email')";

            if ($db->query($sql)) {
                $register_message = [
                    'text' => "Akun maskapai berhasil dibuat",
                    'color' => "#15e600"
                ];
            } else {
                $register_message = [
...
<body>
    <header>
        ...
        <nav>
            ...
            <a href="tambahMaskapai.php" style="background-color: rgba(255, 255, 255, 0.4);">Tambah Maskapai</a>
    ...
    <main>
        <form action="tambahMaskapai.php" method="POST">
            <h3>Tambah Maskapai</h3>
            <label for="username">Username:</label>
            <input type="text" placeholder="Username Maskapai" name="username">
            ...
            <input type="email" placeholder="Email Maskapai" name="email">
